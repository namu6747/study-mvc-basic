...
<section>
	<form id="updateForm" action="updateSubmit.mc" method="POST">
		...
		<table>
			...
			<tr>
				<td>아이디</td>
				<td><input type="email" name="id" placeholder="email"
					value="${member.id}" readonly required /></td>
			</tr>
			<tr>
				<td>비밀번호</td>
			...
			<tr>
				<td>비밀번호확인</td>
				<td><input type="password" name="rePass" id="rePass" required />
				</td>
			</tr>
			<tr>
				<td>이름</td>
			...
			<tr>
				...
				<td><input type="radio" name="gender" value="male"
					${member.gender eq 'male' ? 'checked' : ''} /> 남성 <input
					type="radio" name="gender" value="female"
					${member.gender ne 'male' ? 'checked' : ''} /> 여성</td>
			</tr>
			<tr>
				<td colspan=2><input type="button" id="btn" value="수정완료" /></td>
			</tr>
		</table>
	</form>
</section>
